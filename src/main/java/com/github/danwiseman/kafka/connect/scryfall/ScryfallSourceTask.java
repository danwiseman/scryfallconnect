...
/*    Your connector should never use System.out for logging. All of your classes should use slf4j
  ...
  public List<SourceRecord> poll() throws InterruptedException {
    ...
    JSONArray cards = scryfallAPIHttpClient.getNextCards(nextPageToVisit, nextQuerySince);
    ...
    if (i == 175) {
      ...
      nextQuerySince = DateUtils.InstantFromScryFallDate(lastReleaseAt);
  ...
  private Struct buildRecordValue(Card card) {
    ...
    if (card_related_uris != null) {
      Struct relatedUrisStruct = new Struct(RELATED_URIS_SCHEMA)
              ...
              .put(CARD_RELATED_URIS_TCG_INF_ART, card_related_uris.getTcgplayer_infinite_articles())
              .put(CARD_RELATED_URIS_TCG_ING_DECKS, card_related_uris.getTcgplayer_infinite_decks());
    ...
    if (card_purchase_uris != null) {
      Struct purchaseUrisStruct = new Struct(PURCHASE_URIS_SCHEMA)
              .put(CARD_PURCHASE_URIS_CARDHOARDER, card_purchase_uris.getCardhoarder())
  ...
  private Map<String, String> sourceOffset(Instant updatedAt) {
      Map<String, String> map = new HashMap<>();
      map.put(CARD_RELEASED_AT, DateUtils.ScryFallDateFromInstant(DateUtils.MaxInstant(updatedAt, nextQuerySince)));
